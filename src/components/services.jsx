		...
		<div className="row">
			...
			<div className="col-sm-12 mt-4 card card-body bg-light">
				<div className="py-5 punchline my-3 px-5 text-center">
					<h2>
						Ravitsemusterapeutit taitavat ruokailun ja ravitsemusohjauksen
						lisäksi myös erikoisosaamista vaativat tilanteet, kuten diabeteksen,
						keliakian tai kilpaurheilun asettamat ravitsemukselliset
						erityisvaatimukset.
					</h2>
				</div>
			</div>
